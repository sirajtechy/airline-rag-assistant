...
|---|---|---|---|---|
| No reranker | 0.6667 | 0.9000 | 0.8594 | 0.0000 |
| + Cross-encoder rerank (top-10 -> top-3/5) | 0.6667 | 0.8667 | 0.8423 | 62.1000 |
| + Cross-encoder rerank (top-20 -> top-3/5) | 0.6667 | 0.8333 | 0.8135 | 118.9000 |
...
NDCG@3 falls from 0.8594 with no reranker to 0.8423 at top-10 and 0.8135 at top-20, and at top-20 R@3 drops too (0.9000 -> 0.8333). It costs 118.9 ms per query to be worse. Notably the damage grows with the candidate pool: the more documents it is given to reorder, the more harm it does.
...
Second, **there is almost no headroom to win and plenty to lose**. Hybrid fusion already reaches R@3 = 0.9000; a reranker cannot add documents fusion never retrieved, it can only reshuffle them. When the correct chunk is usually already in the top 3, any reshuffling is far more likely to demote it than promote it.
